...
[STYLE: Togashi hybrid method — sketchy setup (Panel 1, 3), explosive impact text (Panel 2), precise face (Panel 4)]
[DENSITY LEVEL: Lv.2 (Panel 1), Lv.4 (Panel 2), Lv.2 (Panel 3), Lv.3 (Panel 4)]
Keep character identity consistent with reference image.

Panel 1 (top — 35%): Bust shot, upper body of a 42-year-old Japanese man with rectangular black-framed glasses, short slightly messy black hair with grey mixed in. Serious focused eyes, shadow on glasses, analytical gaze. Looking at something intently. Semi-realistic manga style. Loose sketchy lines.

Panel 2 (middle — 35%): Large bold manga impact text dominating the panel center. The man figure small in background, surprised expression, wide eyes. The text overwhelms and dwarfs the character. Tight composition, minimal negative space. Explosive detailed precision for the impact lettering. NOT cyan colored text — black and white only.
