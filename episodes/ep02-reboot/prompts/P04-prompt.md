...
characters:
  shouichi: [confident]
applied_techniques: [T52, T27, T41, T13, T67]
...
Scene: A paper notebook lying on a desk, Shouichi's hand visible holding a pen (face out of frame). Handwritten calculation in Japanese:
...
Scene: Close-up of Shouichi's face (fuller than bust shot). He is now BACK IN THE PARK, standing up from the bench. Autumn afternoon light. Expression: CONFIDENT MODE — teeth-showing shrewd grin, glasses lenses catching a bright WHITE HIGHLIGHT (T41 confident eyeglass-highlight — a clean uniform soft highlight). Shoulders slightly back.

The Pembroke Welsh Corgi (white and brown, monochrome) visible at his knees, looking up.

CRITICAL: The smile is MISCHIEVOUS-EXCITED (ワクワク＋いかがわしい), as excited-shrewd and playful.

Monologue (handwriting caption, larger font, rendered as handwriting captions, positioned around the figure):
- 「——俺は、」 (upper-right area)
