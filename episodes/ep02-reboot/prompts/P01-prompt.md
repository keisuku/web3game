...
characters:
  shouichi: [wine]
applied_techniques: [T30, T05, T60, T69, T48]
...
Scene: High bird's-eye-view of a commercial district mid-afternoon (T05 メタ宣言俯瞰). Autumn atmosphere: cafe signs, sparse pedestrian traffic, empty bench visible on a sidewalk. On the bench: a tiny seated silhouette (Shouichi, rendered small in the distance). A Pembroke Welsh Corgi (white and brown, monochrome) sits beside him. Bare trees, a few fallen leaves.
...
Monologue (handwriting caption, as a handwriting caption, placed in the open space): 「期待と妄想は──毒だ。」「そんな気がしていた。」
